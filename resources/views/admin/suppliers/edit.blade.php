            ...
            <div class="inline-create-block">
                ...
                <div id="new-destination" class="new-field-box">
                    <div class="inner">
                        ...
                        <p class="hint"><i class="ti ti-info-circle" style="font-size:12px"></i> Se creará automáticamente al guardar</p>
                    </div>
                </div>
            </div>
...
// Quita del DOM una fila recién agregada (nunca existió en BD)
function removeNewBankAccount(button) {
    button.closest('.bank-account-row').remove();
    updateBankCounter();
}

// Marca una cuenta YA EXISTENTE para eliminar al guardar (igual que delete_contacts[] en clientes)
