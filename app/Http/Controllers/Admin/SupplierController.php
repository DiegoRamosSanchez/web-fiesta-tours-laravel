...
class SupplierController extends Controller
{
    ...
    {
        $suppliers = Supplier::with(['destination', 'category', 'bankAccounts.bank'])
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.suppliers.index')
                ->with('success', 'Proveedor y cuentas bancarias creados correctamente.');
    ...
    public function destroy(Supplier $supplier)
    {
        try {
            ...
            // Eliminar cuentas bancarias asociadas (onDelete cascade lo hará automáticamente)
            $supplier->delete();
    ...
    // Método opcional para mostrar las cuentas bancarias de un proveedor específico
